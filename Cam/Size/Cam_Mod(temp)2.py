...
class CameraModeTest(unittest.TestCase):
    ...
    def test_02_CameraMode_SettingBurst_5(self): #mode -->burst-->5
        CameraMode_SettingBurst(self.driver)
        CamModeBur_5(self.driver)

    def test_02_CameraMode_SettingBurst_7(self): #mode -->burst-->7
        CameraMode_SettingBurst(self.driver)
        CamModeBur_7(self.driver)

    def test_02_CameraMode_SettingBurst_10(self): #mode -->burst-->10
        CameraMode_SettingBurst(self.driver)
        CamModeBur_10(self.driver)

    def test_02_CameraMode_SettingBurst_14(self): #mode -->burst-->14
        CameraMode_SettingBurst(self.driver)
        CamModeBur_14(self.driver)

    def test_03_CameraMode_Setting_TIMELAPSE_2s(self): #延时拍照 2秒
          CameraMode_Setting_TIMELAPSE(self.driver)
          CamModeLaps_2s(self.driver)

    def test_03_CameraMode_Setting_TIMELAPSE_5s(self): #延时拍照 5秒
          CameraMode_Setting_TIMELAPSE(self.driver)
    ...
    def test_03_CameraMode_Setting_TIMELAPSE_10s(self): #延时拍照 10秒
          CameraMode_Setting_TIMELAPSE(self.driver)
          CamModeLaps_10s(self.driver)

    def test_03_CameraMode_Setting_TIMELAPSE_20s(self): #延时拍照 20秒
          CameraMode_Setting_TIMELAPSE(self.driver)
          CamModeLaps_20s(self.driver)

    def test_03_CameraMode_Setting_TIMELAPSE_30s(self): #延时拍照 30秒
          CameraMode_Setting_TIMELAPSE(self.driver)
          CamModeLaps_30s(self.driver)

    def test_03_CameraMode_Setting_TIMELAPSE_60s(self): #延时拍照 60秒
          CameraMode_Setting_TIMELAPSE(self.driver)

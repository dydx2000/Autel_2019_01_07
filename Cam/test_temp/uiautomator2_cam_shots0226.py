...
d=u2.connect_wifi('192.168.1.21') #
...
class Camera:
    ...
    def SetPictureShutterOP(self,num):
        ...
        if num not in listPara:
            ...
            if d(resourceId="com.autel.explorer:id/tv_first_para",text=num).exists(timeout=2):
                print("%s setted"%num)

            else:
                try:
                    #点击SHUTTER进入模块
                    d(resourceId="com.autel.explorer:id/tv_ui_first_para", text="SHUTTER").click(timeout=1)
                except:
                    logging.exception('------------Exceptions Caught--------')
                ##########################
                time.sleep(0.5)
                #判断所选参数是否可见 ,可见情况
                if d(resourceId="com.autel.explorer:id/tv_second_para", text=num).exists(timeout=1):
                    time.sleep(0.5)
                    try:
                        d(resourceId="com.autel.explorer:id/tv_second_para", text=num).click(timeout=1)
                    except:
                        logging.exception('------------Exceptions Caught--------')
...
########################################################################################################################
        ...
        if num in listPara:
            ...
            for i in range(0, len(listPara)):
                if num == listPara[i]:
                    seq = i
                    break
            if d(resourceId="com.autel.explorer:id/tv_second_para", text=num).exists(timeout=2):
                time.sleep(0.5)
                try:
                    d(resourceId="com.autel.explorer:id/tv_second_para", text=num).click(timeout=2)
                except:
                    logging.exception('------------Exceptions Caught--------')
    ...
    def insideCircleStyle(self,num):
        ...
        # 进入下一层选择 Contrast
        try:
            d(resourceId="com.autel.explorer:id/iv_second_next").click(timeout=2)
        except:
            logging.exception('------------Exceptions Caught--------')
        ...
        # 进入下一层选择 Sharp
        try:
            d(resourceId="com.autel.explorer:id/tv_back").click(timeout=2)
        except:
            logging.exception('------------Exceptions Caught--------')
        time.sleep(2)

        try:
            d(resourceId="com.autel.explorer:id/tv_ui_second_para").click(timeout=2)
            time.sleep(1)
            d(resourceId="com.autel.explorer:id/iv_second_next").click(timeout=2)
        except:
            logging.exception('------------Exceptions Caught--------')
        ...
        #进入下一层选择 saturation
        try:
            d(resourceId="com.autel.explorer:id/tv_back").click(timeout=1)
        except:
            logging.exception('------------Exceptions Caught--------')
        time.sleep(3)
        ...
        try:
            d(resourceId="com.autel.explorer:id/tv_ui_second_para", text=u"SATURATION").click(timeout=1)
            time.sleep(1)
            d(resourceId="com.autel.explorer:id/iv_second_next").click(timeout=1)
        except:
            logging.exception('------------Exceptions Caught--------')
    ...
    def SetPitureStyle(self,num):
        ...
        if num not in ["STD.", "NEUT.", "LAND."]:
            ...
            if d(resourceId="com.autel.explorer:id/tv_first_para", text=num).exists(timeout=1):
                print("Style %s is Setted"%num)
                ...
                try:
                    ...
                    logging.exception('------------Exceptions Caught--------')
                if d(resourceId="com.autel.explorer:id/iv_second_next").exists(timeout=1):
                    if d(resourceId="com.autel.explorer:id/tv_second_para", text=num).exists(timeout=1):# "指定参数" 和 (...)均存在的情况
                        pass   #己经存在该选择项
                    ...
                    while j<=3:
                        ...
                        if d(resourceId="com.autel.explorer:id/iv_second_next").exists(timeout=1):
                            ...
                            # (...)存在, xxxxK不存在的情况,点(...)进入下一层循环
                                ...
                                try:
                                    d(resourceId="com.autel.explorer:id/iv_second_next").click(time=1)
                                except:
                                    logging.exception('------------Exceptions Caught--------')
                                time.sleep(0.5)
...
##---------------------------- Recoding Module ------------------------------------##
    ...
    def setVedioStyle(self,num):
        ...
        if num not in ["STD.", "NEUT.", "LAND."]:
            ...
            if d(resourceId="com.autel.explorer:id/tv_first_para", text=num).exists(timeout=2):
                ...
                try:
                    d(resourceId="com.autel.explorer:id/tv_ui_first_para", text=u"STYLE").click(timeout=2)
                except:
                    logging.exception('------------Exceptions Caught--------')
                if d(resourceId="com.autel.explorer:id/iv_second_next").exists(timeout=2):
                    if d(resourceId="com.autel.explorer:id/tv_second_para", text=num).exists(timeout=2):# "指定参数" 和 (...)均存在的情况
                        pass   #己经存在该选择项

                     #(...)存在, "xx xx xx"不存在的情况,点(...)进入下一层循环
                    elif not  d(resourceId="com.autel.explorer:id/tv_second_para", text=num).exists(timeout=2):
                        time.sleep(0.5)
                        try:
                            d(resourceId="com.autel.explorer:id/iv_second_next").click(timeout=2)
                        except:
    ...
    def record(self):
        #录相按钮存在
        time.sleep(1)
        if d(resourceId="com.autel.explorer:id/iv_camera_record_controller").exists(timeout=5):

            try:
                d(resourceId="com.autel.explorer:id/iv_camera_record_controller").click(timeout=3)
                print("record()")
            except:
        ...
        # 录相按钮不存在
            ...
            d(resourceId="com.autel.explorer:id/iv_mode_switcher").click(timeout=3)
            time.sleep(1)
            try:
                d(resourceId="com.autel.explorer:id/iv_camera_record_controller").click(timeout=3)
            except:
...
##---------------------------- Camera Settings ------------------------------------##
    ...
    def camSetHis(self,num):
        ...
        r,g,b =im.split()
        # color =b.getpixel((1766, 591)) #oneplus
        color = b.getpixel((1363, 391))  #s8

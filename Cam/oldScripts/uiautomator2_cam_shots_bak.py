...
class Camera:
    ...
    #相机 mode　子项选择
    def SetPictureMode_pre(self,mode):
                    ...
                    if d(resourceId="com.autel.explorer:id/tv_second_para", text=listMode[i]):
                        ...
                        if i > seq:
                            ...
                            while j <= 10:
                                ...
                                #     time.sleep(5)
                                #     try:
                                #         # d.xpath("//android.widget.TextView[@text='BURST']").click()
                                #         d(resourceId="com.autel.explorer:id/tv_second_para", text=mode).click()
                                #     except:
                                #         pass
                                #     finally:
...
def main():
    ...
    # test.SetPictureIso("100")
    # test.SetPictureShutter("1\"")
    # test.SetPictureFomat("JPG")
    # test.SetPictureColor("FILM")
    # test.SetPictureDigizoom("6.0X")
    # test.SetpicureEv("-1.7")
    # test.SetPitureWB("5600K")

...
d=u2.connect_wifi('192.168.1.27') #One Plus 3
...
##---------------------------- Recoding Module ------------------------------------##
    ...
    def scrollToAVFunc(self,func):
        ...
        if func in listAll:
            ...
            print("You have iput a wrong Record Function.")
    ...
    def setVideoFramerate(self,num):
        ...
        if d(resourceId="com.autel.explorer:id/tv_first_para",text=num).exists():
            ...
            if ratetext == "4K+":
                ...
                listPara =["120P","60FPS","48FPS","30FPS","24FPS"]
            elif ratetext == "720P":
                listPara = ["240p","60FPS","48FPS","30FPS","24FPS"]
            else:
                logging.exception(ParaError)

...
logging.basicConfig(level=logging.INFO,
                    format='\n\r%(asctime)s %(filename)s[line:%(lineno)d] %(levelname)s %(message)s %(funcName)s',
...
# d=u2.connect_wifi('192.168.1.24') #samsung s7
# d=u2.connect_wifi('10.250.16.241') #samsung s7
...
##---------------------------- Recoding Module ------------------------------------##
    ...
    def camSetGrid(self,num):
        ...
        try:
            if d(resourceId="com.autel.explorer:id/iv_camera_setting").exists():

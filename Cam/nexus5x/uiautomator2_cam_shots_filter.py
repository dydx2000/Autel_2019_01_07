...
d=u2.connect_wifi('192.168.1.13') #samsung s7
...
class Camera:
    ...
    def shot(self):
        ...
        #在拍照画面
        try:
            if  d(resourceId="com.autel.explorer:id/rel_camera_takephoto_controller").exists(3):
                try:
                    d(resourceId="com.autel.explorer:id/rel_camera_takephoto_controller").click_exists(5)
                    print("shot()")
                except:
                    self.catchError()

                if d(resourceId="com.autel.explorer:id/toast_msg_tv",text='SD card is full').exists(3):
            ...
            # 在录相界面
                ...
                if d(resourceId="com.autel.explorer:id/iv_camera_record_controller").exists(3):
                    try:
                        d(resourceId="com.autel.explorer:id/iv_mode_switcher").click_exists(5)
                        time.sleep(0.5)
                        d.implicitly_wait(5.0)
                        if d(resourceId="com.autel.explorer:id/rel_camera_takephoto_controller").exists(3):
                            d(resourceId="com.autel.explorer:id/rel_camera_takephoto_controller").click_exists(5)
    ...
    def mainWindowConfirm(self):  # 确认在相机主画面
        ...
        if d(resourceId="com.autel.explorer:id/rel_camera_controller").exists(3):
        # if d(resourceId="com.autel.explorer:id/iv_camera_outer").exists(3):
        ...
        # ("指南针按钮 "): 说明在地图模式,点击小图切换到相机
            ...
            # 切换成功的情况
            if d(resourceId="com.autel.explorer:id/rel_camera_controller").exists(3):  # 切换成功的情况
                print('Is in shotting or recording window.')

            # 切换不成功的情况
            else:
                d(resourceId="com.autel.explorer:id/intercept_img_shrink").click_exists(5)  # 把小图展开,再点小图中央切换到拍摄画面,
                time.sleep(2)
                d.click(0.14, 0.268)
                time.sleep(1)
                d.implicitly_wait(5.0)
        ...
        # 在相册画面
        elif d(resourceId="com.autel.explorer:id/tv_enter_album_list").exists(3):
            ...
            if d(resourceId="com.autel.explorer:id/rel_camera_controller").exists(3):
                print('Is in shotting or recording window.')
        # 在相册列表画面
        elif d(resourceId="com.autel.explorer:id/tv_album_select").exists(3):
        ...
        # 在智能飞行界面
            ...
            # 点击相机按钮
            d(resourceId="com.autel.explorer:id/model_choice_bg").click_exists(5)
            time.sleep(0.5)
            d.implicitly_wait(5.0)
            if d(resourceId="com.autel.explorer:id/rel_camera_controller").exists(3):
                print('Is in shotting or recording window.')
        # 在通用设置界面
            ...
            if d(resourceId="com.autel.explorer:id/rel_camera_controller").exists(3):
                print('Is in shotting or recording window.')
        # 在相机设置界面
        elif d(resourceId="com.autel.explorer:id/camera_general_setting_title").exists(3):
        ...
        elif d(resourceId="com.autel.explorer:id/warn_history_title_tv").exists(3):  # 在飞机状态画面
            ...
            print("Now in unknown interface.")
        time.sleep(2)
    ...
    def FunctionSelect(self,func,listAll):
        ...
        if func in listAll:
            for i in range(0, len(listAll)):
                if func == listAll[i]:
                    seq = i
                    if d(resourceId="com.autel.explorer:id/tv_ui_first_para", text=func).exists(3):
                        ...
                        try:
                            ...
                            while i <= len(listAll):  # 通过参数指定模式的参数编号 seq 与 当前滑块 最左边的 所见元素的编号比较, seq比较大,就左移,否则右移
                                flag = False
                                if d(resourceId="com.autel.explorer:id/tv_ui_first_para", text=listAll[i]).exists(3):
                                    ...
                                    if i > seq:
                                        ...
                                        while j <= 10:
                                            ...
                                            if d(resourceId="com.autel.explorer:id/tv_ui_first_para",
                                                 text=func).exists(3):
                                                # d(resourceId="com.autel.explorer:id/tv_ui_first_para", text=func).click_exists(5)
                                                print('find %s' % func)
                                                flag = True
                                                break
                                            else:
    ...
    def SetPictureSize(self,num):
        ...
        listPara = ["4000x2250(16:9)","4000x3000(4:3)",]
        func = 'SIZE'
        time.sleep(2)
        ...
        if num in listPara:
            ...
            for i in range(0, len(listPara)):
                if num == listPara[i]:
                    ...
                    break
            time.sleep(0.5)
            if d(resourceId="com.autel.explorer:id/tv_second_para", text=num).exists(3):
                try:
                    d(resourceId="com.autel.explorer:id/tv_second_para", text=num).click_exists(5)
    ...
    def SetPictureMode(self,mode,num=None):
        ...
        time.sleep(1.5)
        try:
            d(resourceId="com.autel.explorer:id/tv_ui_first_para", text='MODE').click_exists(5)
        except:
            self.catchError()
        time.sleep(1)
        ...
        if  d(resourceId="com.autel.explorer:id/tv_second_para", text=mode):         #没有的话就往左或者往右翻找找吧
            ...
            if mode == "SINGLE":
                logging.info("single start")
                try:
                    d(resourceId="com.autel.explorer:id/tv_second_para", text=mode).click_exists(5)
                except:
                    self.catchError()
                ...
                try:
                    if d(resourceId="com.autel.explorer:id/iv_second_next"):
                        d(resourceId="com.autel.explorer:id/iv_second_next").click_exists(5)
                        time.sleep(1.5)
                        if mode == "BURST":
                            logging.info("burst start")
                            self.insideCircleBurst(num)
                            logging.info("burst ends")

                        elif mode == "TIMELAPSE":
                            logging.info("timelapse start")
                            self.insideCircleTimelapse(num)
                            logging.info("timelapse ends")

                        else:
                            logging.info("Aeb start")

                            self.insideCircleAeb(num)
                            logging.info("Aeb end")
                ...
                if mode in listMode:
                    ...
                    try:
                        ...
                        while i <= len(listMode):  # 通过参数指定模式的参数编号 seq 与 当前滑块 最左边的 所见元素的编号比较, seq比较大,就左移,否则右移
                            ...
                            time.sleep(1)
                            d.implicitly_wait(5)
                            if d(resourceId="com.autel.explorer:id/tv_second_para", text=listMode[i]).exists(3):
                                    ...
                                    while j <= 10:
                                        ...
                                        if d(resourceId="com.autel.explorer:id/tv_second_para", text=mode):
                                            ...
                                            if mode == "SINGLE":
                                                ...
                                                time.sleep(1)
                                                d.click(0.5, 0.5)
                                        # if d(resourceId="com.autel.explorer:id/tv_second_para", text=mode).exists(3):
                                            else:
                                                try:
                                                    d(resourceId="com.autel.explorer:id/tv_second_para", text=mode).click_exists(5)
                                                    time.sleep(1.5)
    ...
    def outsidecircle(self,num,listPara,func):
        ...
        try:
            ...
            #输入参数有效的情况下:
                ...
                #参数在主画面显示的情况下
                if d(resourceId="com.autel.explorer:id/tv_first_para",text=num).exists(3):
                    print("%s setted" % num)
                ...
                # 参数未在主画面显示的情况下
                    ...
                    if d(resourceId="com.autel.explorer:id/tv_second_para", text=num).exists(3):
                        ...
                        while i <= len(listPara):  # 通过参数指定模式的参数编号 seq 与 当前滑块 最左边的 所见元素的编号比较, seq比较大,就左移,否则右移
                            ...
                            flag = False
                            if d(resourceId="com.autel.explorer:id/tv_second_para", text=listPara[i]).exists(3):
    ...
    def SetPictureShutterOP(self, num):
            ...
            if num not in listPara:
                ...
                if d(resourceId="com.autel.explorer:id/tv_first_para", text=num).exists(3):
                    ...
                    try:
                        # 点击SHUTTER进入模块
                        d(resourceId="com.autel.explorer:id/tv_ui_first_para", text="SHUTTER").click_exists(5)
                        time.sleep(1.5)
                    except:
                        self.catchError()
                    # time.sleep(0.5)
    ...
    def SetPictureWB(self,num):
        ...
        if num in ["AUTO", "SUNNY", "CLOUDY", "INCAN", "NEON"]:  # 预设的情况:
            ...
            if d(resourceId="com.autel.explorer:id/tv_first_para", text=num).exists(3):
                ...
                try:
                    d(resourceId="com.autel.explorer:id/tv_ui_first_para", text=u"WB").click_exists(5)
                    time.sleep(1.5)
                except:
                    self.catchError()
                # (...) 存在的情况
                if d(resourceId="com.autel.explorer:id/iv_second_next").exists(3):
                    if d(resourceId="com.autel.explorer:id/tv_second_para", text=num).exists(3):# xxxxK 和 (...)均存在的情况
                        pass   #己经存在该选择项
                     #(...)存在, xxxxK不存在的情况,点(...)进入下一层循环
                    elif not  d(resourceId="com.autel.explorer:id/tv_second_para", text=num).exists(3):
                        try:
                            d(resourceId="com.autel.explorer:id/iv_second_next").click_exists(5)
                            time.sleep(1.5)
    ...
    def insideCircleStyle(self,num):
        ...
        try:
            d(resourceId="com.autel.explorer:id/tv_back").click_exists(5)
            time.sleep(0.5)
        except:
            self.catchError()
        ...
        try:
            d(resourceId="com.autel.explorer:id/tv_ui_second_para").click_exists(5)
            time.sleep(0.5)
            d(resourceId="com.autel.explorer:id/iv_second_next").click_exists(5)
            time.sleep(0.5)
        except:
        ...
        try:
            d(resourceId="com.autel.explorer:id/tv_ui_second_para", text=u"SATURATION").click_exists(5)
            time.sleep(0.5)
        except:
            self.catchError()
        try:
    ...
    def SetPitureStyle(self,num):
        ...
        if num not in ["STD.", "NEUT.", "LAND."]:
            ...
            if d(resourceId="com.autel.explorer:id/tv_first_para", text=num):
                ...
                try:
                    d(resourceId="com.autel.explorer:id/tv_ui_first_para", text=u"STYLE").click_exists(5)
                    time.sleep(0.5)
                    if d(resourceId="com.autel.explorer:id/iv_second_next").exists(3):
                        if d(resourceId="com.autel.explorer:id/tv_second_para",
                             text=num).exists(3):  # "指定参数" 和 (...)均存在的情况
                            pass  # 己经存在该选择项
    ...
    def GimbalAngle(self,num):
        ...
        try:
            ...
            if num == angle:
                ...
                d(resourceId="com.autel.explorer:id/rl_gimbal_angle").click_exists(5)
                time.sleep(1.5)
    ...
    def setVideoFramerate(self,num):
        ...
        try:
            if d(resourceId="com.autel.explorer:id/tv_first_para",text=num).exists(3):
                ...
                if d(resourceId="com.autel.explorer:id/tv_first_para", text=u"4K+").exists(3):
                     ratetext=d(resourceId="com.autel.explorer:id/tv_first_para", text=u"4K+").get_text()
                elif d(resourceId="com.autel.explorer:id/tv_first_para", text=u"4K").exists(3):
                     ratetext = d(resourceId="com.autel.explorer:id/tv_first_para", text=u"4K").get_text()
                elif d(resourceId="com.autel.explorer:id/tv_first_para", text=u"2.7K").exists(3):
                     ratetext = d(resourceId="com.autel.explorer:id/tv_first_para", text=u"2.7K").get_text()
                elif d(resourceId="com.autel.explorer:id/tv_first_para", text=u"1080P").exists(3):
                     ratetext = d(resourceId="com.autel.explorer:id/tv_first_para", text=u"1080P").get_text()
                elif d(resourceId="com.autel.explorer:id/tv_first_para", text=u"720P").exists(3):
            ...
            if d(resourceId="com.autel.explorer:id/tv_first_para", text=num).exists(3):
                ...
                # (...)不存在的情况
                    ...
                    while i <= 2:
                        ...
                        if d(resourceId="com.autel.explorer:id/iv_second_next").exists(3):
                            if d(resourceId="com.autel.explorer:id/tv_second_para",
                                 text=num).exists(3):  # xxxxK 和 (...)均存在的情况
                                break  # 己经存在该选择项
                            # (...)存在, xxxxK不存在的情况,点(...)进入下一层循环
                            elif not d(resourceId="com.autel.explorer:id/tv_second_para", text=num).exists(3):
                                try:
    ...
    def setVedioStyle(self,num):
        ...
        # 是预设前三项情况
            ...
            try:
                ...
                if d(resourceId="com.autel.explorer:id/tv_ui_second_para", text=num).exists(3):

                    try:
                        d(resourceId="com.autel.explorer:id/tv_ui_second_para", text=num).click_exists(5)
                        time.sleep(0.5)
                        print("Style %s  Set"%num)
    ...
    def record(self):
        ...
        if d(resourceId="com.autel.explorer:id/iv_camera_record_controller"):
            try:
                d(resourceId="com.autel.explorer:id/iv_camera_record_controller").click_exists(5)
                print("record()")
            except:
                self.catchError()
    ...
    def camSetGrid(self,num):
        ...
        try:
            if d(resourceId="com.autel.explorer:id/iv_camera_setting").wait(3):
                d(resourceId="com.autel.explorer:id/iv_camera_setting").click_exists(5)
            else:
                d(resourceId="com.autel.explorer:id/rl_camera_setting").click_exists(5)
            time.sleep(1.5)

            if d(resourceId="com.autel.explorer:id/view_chart").wait(3):
                d(resourceId="com.autel.explorer:id/layout_histogram_cancel").click_exists(5)
                time.sleep(0.5)
            time.sleep(0.5)
            d(resourceId="com.autel.explorer:id/rl_general_setting_item").click_exists(5)
            time.sleep(1)

            if num == 'None':
                time.sleep(0.5)
                d.implicitly_wait(5.0)
                d(resourceId="com.autel.explorer:id/general_setting_image_item_value_text").click_exists(5)
            elif num == 'Grid':
                time.sleep(0.5)
                d.implicitly_wait(5.0)
                d(resourceId="com.autel.explorer:id/general_setting_image_item_value_text", text=u"Grid").click_exists(5)
            elif num == 'Grid + Line':
                time.sleep(0.5)
                d.implicitly_wait(5.0)
                d(resourceId="com.autel.explorer:id/general_setting_image_item_value_text", text=u"Grid + Line").click_exists(5)
            else:
                pass
            time.sleep(2)
    ...
    def camSetCenterPoint(self,num):
        ...
        try:
            d(resourceId="com.autel.explorer:id/iv_camera_setting").click_exists(5)
            time.sleep(0.5)
            d(resourceId="com.autel.explorer:id/item_general_setting_key_tv", text=u"Center Point").click_exists(5)
            time.sleep(0.5)
        except:
            self.catchError()
        ...
        if num == 'None':
            ...
            d(resourceId="com.autel.explorer:id/general_setting_image_item_value_text",
              text=u"Square(Without Center Point)").click_exists(5)
        elif num == 'SquareWith':
            d.implicitly_wait(5.0)
            d(resourceId="com.autel.explorer:id/general_setting_image_item_value_text",
              text=u"Square(With Center Point)").click_exists(5)
        elif num == 'Cross':
            d(resourceId="com.autel.explorer:id/general_setting_image_item_value_text", text=u"Cross").click_exists(5)
        elif num == 'CircleWith':
            d.implicitly_wait(5.0)
            d(resourceId="com.autel.explorer:id/general_setting_image_item_value_text",
              text=u"Circle(With Center Point)").click_exists(5)
        elif  num == 'CircleWithout':
            d.implicitly_wait(5.0)
            d(resourceId="com.autel.explorer:id/general_setting_image_item_value_text",
              text=u"Circle(Without Center Point)").click_exists(5)
        else:
            pass
        time.sleep(0.5)
        d.click(0.3,0.5)
    ...
    def camSetHis(self,num):
        ...
        if num == status:
            ...
            try:
                d(resourceId="com.autel.explorer:id/item_general_setting_autel_ss").click_exists(5)
                time.sleep(1)
            except:
                self.catchError()
        ...
        try:
            ...
            if int(text[:-3]) < 100:
                ...
                try:
                    d(resourceId="com.autel.explorer:id/iv_camera_setting").click_exists(5)
                    time.sleep(3)
                    d.swipe(0.58, 0.6, 0.58, 0.3)
                    # self.swipe_right_up()
                    time.sleep(2)
                    if d(resourceId="com.autel.explorer:id/item_general_setting_key_tv", text=u"Anti-Flicker").exists(5):
                    ...
                    if text == num:
                        ...
                        try:
                            d(resourceId="com.autel.explorer:id/item_general_setting_key_tv",
                              text=u"Anti-Flicker").click_exists(5)
                            time.sleep(1.5)
                            if num == 'Auto':
                                d(resourceId="com.autel.explorer:id/general_setting_tv_item_value").click_exists(5)
                            elif num == '50Hz':
                                d(resourceId="com.autel.explorer:id/general_setting_tv_item_value",
                                  text=u"50Hz").click_exists(5)
                            elif num == '60Hz':
                                d(resourceId="com.autel.explorer:id/general_setting_tv_item_value",
                                  text=u"60Hz").click_exists(5)
                            else:
                                pass
    ...
    def camSetVideoEncoding(self,num):
        ...
        try:
            ...
            if d(resourceId="com.autel.explorer:id/item_general_setting_value_tv", text=num):
                ...
                d(resourceId="com.autel.explorer:id/item_general_setting_key_tv",
                  text=u"Video Encoding Format").click_exists(5)
                time.sleep(1.5)
                d.implicitly_wait(3.0)
                ...
                if num == 'H.264':
                    ...
                    try:
                        d(resourceId="com.autel.explorer:id/general_setting_tv_item_value", text=u"H.265").click_exists(5)
                    except:
                        self.catchError()
    ...
    def camSetFormatsdcard(self,num):
        ...
        try:
            ...
            time.sleep(2)
            d(resourceId="com.autel.explorer:id/item_general_setting_key_tv", text=u"Format SD Card").click_exists(5)
            time.sleep(2)
            if num == 'yes':
    ...
    def  camReset(self,num):
        ...
        try:
            d(resourceId="com.autel.explorer:id/item_general_setting_key_tv", text=u"Reset Camera").click_exists(5)
            time.sleep(2)
    ...
    def camSettingsReset(self):
        ...
        try:
            ...
            if d(resourceId="com.autel.explorer:id/camera_general_setting_title").exists(3):
                self.swipe_right_up()
                time.sleep(0.8)
                if d(resourceId="com.autel.explorer:id/item_general_setting_key_tv", text=u"Reset Camera").exists(3):
                    d(resourceId="com.autel.explorer:id/item_general_setting_key_tv", text=u"Reset Camera").click_exists(5)
                    time.sleep(1.5)
                    d.implicitly_wait(5.0)
                    d(resourceId="com.autel.explorer:id/tv_ok").click_exists(5)
    ...
    def test_into_Album(self):
        if d(resourceId="com.autel.explorer:id/tv_autel_home_start").exists(3):
            ...
            time.sleep(0.5)
        elif  d(resourceId="com.autel.explorer:id/civ_album_playback").exists(3):
            d(resourceId="com.autel.explorer:id/civ_album_playback").click_exists(5)
            time.sleep(0.5)
        elif d(resourceId="com.autel.explorer:id/iv_setting_close").exists(3):
            d(resourceId="com.autel.explorer:id/iv_setting_close").click_exists(5)
            time.sleep(0.1)
            d(resourceId="com.autel.explorer:id/civ_album_playback").click_exists(5)
            time.sleep(0.5)
            ...
            d(resourceId="com.autel.explorer:id/civ_album_playback").click_exists(5)
            time.sleep(0.5)
        elif  d(resourceId="com.autel.explorer:id/iv_mode_switcher").exists(3):
            d(resourceId="com.autel.explorer:id/civ_album_playback").click_exists(5)
            time.sleep(0.5)
        elif d(resourceId="com.autel.explorer:id/tv_enter_album_list").exists(3):
            pass
    ...
    def test_into_Album_List(self):
        ...
        if d(resourceId="com.autel.explorer:id/tv_autel_home_start").exists(3):
            ...
            d(resourceId="com.autel.explorer:id/civ_album_playback").click_exists(5)
            time.sleep(0.5)
            d(resourceId="com.autel.explorer:id/tv_enter_album_list").click_exists(5)
            time.sleep(1)
            d.implicitly_wait(5)
         #在相册预览界面
        elif  d(resourceId="com.autel.explorer:id/civ_album_playback").exists(3):
...
#-------------------------------其他接口-----------------------------------------#
    ...
    def goStart(self):
        ...
        #在飞行方录界面
        elif d(resourceId="com.autel.explorer:id/flight_record_device_sn_tv").exists(3):
...
def main():
    ...
    # ifchecked=d(resourceId="com.autel.explorer:id/view_chart",clickable=False).exists(3)
    # print(ifchecked)

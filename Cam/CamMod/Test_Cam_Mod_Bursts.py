...
class CameraModeTest(unittest.TestCase):
    ...
    def test_01_CameraMode_SettingBurst_3(self):#mode -->burst-->3   3连拍
        CameraMode_SettingBurst(self.driver)
        CamModeBur_3(self.driver)

    def test_02_CameraMode_SettingBurst_5(self): #mode -->burst-->5  5连拍
        CameraMode_SettingBurst(self.driver)
        CamModeBur_5(self.driver)

    def test_03_CameraMode_SettingBurst_7(self): #mode -->burst-->7
        CameraMode_SettingBurst(self.driver)
        CamModeBur_7(self.driver)

    def test_04_CameraMode_SettingBurst_10(self): #mode -->burst-->10
        CameraMode_SettingBurst(self.driver)
        CamModeBur_10(self.driver)

    def test_05_CameraMode_SettingBurst_14(self): #mode -->burst-->14
        CameraMode_SettingBurst(self.driver)

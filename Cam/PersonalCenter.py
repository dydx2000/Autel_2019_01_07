...
def goStart():
    ...
    #在个人信息中心
     ...
     #在功能界面
    elif d(resourceId="com.autel.explorer:id/rl_left", className="android.widget.RelativeLayout").exists():
    ...
    # def intoPerCenter():
    #     #在首页的情景
    #     if d(resourceId="com.autel.explorer:id/tv_autel_home_start", text=u"GO FLY", className="android.widget.TextView").exists():
    #         d(resourceId="com.autel.explorer:id/iv_user_icon_default", className="android.widget.ImageView").click()
    #     #在注册登录界面
    #     if d(resourceId="com.autel.explorer:id/ed_pwd", className="android.widget.EditText").exists():
...
def intoForgetPwd():
    ...
    #     pass
    #在登录页
    if d(resourceId="com.autel.explorer:id/tv_register", text=u"Register", className="android.widget.TextView").exists():
        d(resourceId="com.autel.explorer:id/tv_forget_pwd", text=u"Forget your password?",
          className="android.widget.TextView").click()
     #在注册页
    elif d(resourceId="com.autel.explorer:id/tv_register", text=u"Login", className="android.widget.TextView").exists():
        d(resourceId="com.autel.explorer:id/tv_register", text=u"Login", className="android.widget.TextView").click()
        d.implicitly_wait(5)
        d(resourceId="com.autel.explorer:id/tv_forget_pwd", text=u"Forget your password?",
          className="android.widget.TextView").click()
     #在首页
    elif    d(resourceId="com.autel.explorer:id/tv_autel_home_start", text=u"GO FLY", className="android.widget.TextView").exists():
        d(resourceId="com.autel.explorer:id/iv_user_icon_default", className="android.widget.ImageView").click()
        d.implicitly_wait(5)
        d(resourceId="com.autel.explorer:id/tv_forget_pwd", text=u"Forget your password?",
          className="android.widget.TextView").click()
...
def  modifyUserName(name):
    if d(resourceId="com.autel.explorer:id/tv_common_title", text=u"Personal Information", className="android.widget.TextView").exists():
        print('is in Personal Information.')
    else:
        intoPerInfo()
    d(resourceId="com.autel.explorer:id/tv_left_title", text=u"Name", className="android.widget.TextView").click()
    time.sleep(1)
    d.implicitly_wait(5)
    if d(resourceId="com.autel.explorer:id/et_username",  className="android.widget.EditText").get_text() == name:
        ...
        try:
            ...
            time.sleep(1)
            d.implicitly_wait(5)
            d(resourceId="com.autel.explorer:id/btn_submit", text=u"Submit", className="android.widget.Button").click()
...
def modifyGender(sex):
    if    d(resourceId="com.autel.explorer:id/tv_common_title", text=u"Personal Information",
           ...
           intoPerInfo()
    d(resourceId="com.autel.explorer:id/tv_left_title", text=u"Gender", className="android.widget.TextView").click()
    time.sleep(1)
    if sex=='Private':
        d(resourceId="com.autel.explorer:id/tv_name", text=u"Private", className="android.widget.TextView").click()
    elif sex =='Female':
        d(resourceId="com.autel.explorer:id/tv_name", text=u"Female", className="android.widget.TextView").click()
    elif sex =='Male':
        d(resourceId="com.autel.explorer:id/tv_name", text=u"Male", className="android.widget.TextView").click()
    else:
...
def modifyCountry(country):
    ...
    if curCountry =="": #空
            d.implicitly_wait(5)
            print('个人中心未设置国家或地区！')
            d(resourceId="com.autel.explorer:id/iv_more_info_indicator", className="android.widget.ImageView", instance=2).click()
            i = 0
            while i <= 30:
    ...
    # 不空
        ...
        if country == curCountry:
            ...
            d.implicitly_wait(5)
            #国家地区是否出现在可见区域中
            if d(resourceId="com.autel.explorer:id/tv_name", text=country, className="android.widget.TextView").exists():
                d(resourceId="com.autel.explorer:id/tv_name", text=country, className="android.widget.TextView").click()
            else:
...
def loginifnotlogin(mail,passwd):
    ...
    if d(resourceId="com.autel.explorer:id/tv_register").exists():
        ...
        time.sleep(2)
        d.click(0.3,0.5)
    elif d(resourceId="com.autel.explorer:id/iv_user_setting").exists():
...
def test_outPerCenter1_2():
    intoPerCenter()
    if d(resourceId="com.autel.explorer:id/iv_user_photo", className="android.widget.ImageView").exists():
        d.click(0.3,0.5)
...
def RegisterUi2_1():
    ...
    #在登录界面
    if d(resourceId="com.autel.explorer:id/tv_register", text=u"Register", className="android.widget.TextView").exists():
        d(resourceId="com.autel.explorer:id/tv_register", text=u"Register", className="android.widget.TextView").click()
    #己经登录
    elif  d(resourceId="com.autel.explorer:id/iv_user_setting", className="android.widget.ImageView").exists():
          d(resourceId="com.autel.explorer:id/iv_user_photo", className="android.widget.ImageView").click()
          d.implicitly_wait(5)
          d(resourceId="com.autel.explorer:id/tv_logout", text=u"Logout", className="android.widget.TextView").click()
          d.implicitly_wait(10)
...
def test_RegisterUser2_21_28():
    ...
    d(resourceId="com.autel.explorer:id/btn_login", text=u"Register", className="android.widget.Button").click()
    d.implicitly_wait(10)
    if d(resourceId="com.autel.explorer:id/tv_dlg_msg", text=u"Registration successful",
      className="android.widget.TextView").exists():
        print("Registration successful")
    elif d(resourceId="com.autel.explorer:id/tv_bottom", text=u"This email has been registered. Please re-enter.", className="android.widget.TextView").exists():
        print('已注册过该用户！')
    else:
        pass
...
def test_RegisterUser2_24():
    ...
    if d(resourceId="com.autel.explorer:id/tv_dlg_msg", text=u"Registration successful",
      className="android.widget.TextView").exists():
        print("Registration successful")
    elif d(resourceId="com.autel.explorer:id/tv_bottom", text=u"Please enter a valid email address.", className="android.widget.TextView").exists():
...
def test_RegisterUser2_25():
    ...
    if d(resourceId="com.autel.explorer:id/tv_dlg_msg", text=u"Registration successful",
      className="android.widget.TextView").exists():
        ...
        print("Email Address format error!")
    if d(resourceId="com.autel.explorer:id/tv_bottom", text=u"Your password must contain at least 1 letter and 1 number.", className="android.widget.TextView").exists():
...
def test_RegisterUser2_26():
    ...
    if d(resourceId="com.autel.explorer:id/tv_dlg_msg", text=u"Registration successful",
      className="android.widget.TextView").exists():
        ...
        print("Email Address format error!")
    elif d(resourceId="com.autel.explorer:id/tv_bottom", text=u"Your password must contain at least 1 letter and 1 number.", className="android.widget.TextView").exists():
        print('password format error!')
    elif d(resourceId="com.autel.explorer:id/tv_bottom", text=u"Passwords do not match, please re-enter.", className="android.widget.TextView").exists():
...
def test_login2_46():
    ...
    if d(resourceId="com.autel.explorer:id/tv_bottom", text=u"This email has not been registered with Autel.", className="android.widget.TextView").exists():
...
def test_login2_47():
    ...
    # d(resourceId="com.autel.explorer:id/btn_login", text=u"Login", className="android.widget.Button").click()
    # time.sleep(2)
    if d(resourceId="com.autel.explorer:id/tv_bottom", text=u"Your email or password was incorrect. Please try again.", className="android.widget.TextView").exists():
        print('邮箱或密码错误，用例通过！')
...
def test_findPwd2_51_57():
    ...
    d.implicitly_wait(5.0)
    d(resourceId="com.autel.explorer:id/btn_send_email").click()
    time.sleep(5)
...
def test_PercenterUiCheck3_1234():
    goStart()
    d(resourceId="com.autel.explorer:id/iv_user_icon").click()
    d(resourceId="com.autel.explorer:id/iv_user_photo").click()
    time.sleep(2)
    d(resourceId="com.autel.explorer:id/iv_common_back").click()
    time.sleep(2)
    ...
    time.sleep(2)
    d(resourceId="com.autel.explorer:id/tv_item_content", text=u"My Devices").click()
    time.sleep(0.5)
    d(resourceId="com.autel.explorer:id/iv_common_back").click()
    time.sleep(0.5)
...
def PerInfoClickicon():
    goStart()
    intoPerInfo()
    d(resourceId="com.autel.explorer:id/iv_user_info_photo", className="android.widget.ImageView").click()
    time.sleep(1)
    if d(resourceId="com.autel.explorer:id/tv_album", text=u"Album", className="android.widget.TextView").exists() and \
        d(resourceId="com.autel.explorer:id/tv_take_photo", text=u"Take a photo", className="android.widget.TextView").exists():
...
def PerInfoClickiconfromAlbum4_24():
    ...
    d(resourceId="com.autel.explorer:id/iv_user_info_photo", className="android.widget.ImageView").click()
    time.sleep(1)
    d(resourceId="com.autel.explorer:id/tv_album", text=u"Album", className="android.widget.TextView").click()
    time.sleep(3)
    d.implicitly_wait(5.0)
    d(resourceId="com.android.documentsui:id/icon_thumb").click()
    time.sleep(3)
    d(resourceId="com.google.android.apps.photos:id/cpe_save_button").click()
    time.sleep(2)
...
def PerInfoClickiconfromCam4_27():
    ...
    d(resourceId="com.autel.explorer:id/iv_user_info_photo", className="android.widget.ImageView").click()
    time.sleep(1)
    d(resourceId="com.autel.explorer:id/tv_take_photo", text=u"Take a photo", className="android.widget.TextView").click()

    time.sleep(2)

    d(resourceId="NONE", text=u"Shutter").click()
    d.implicitly_wait(5)
    d(resourceId="com.sec.android.app.camera:id/okay").click()
    time.sleep(2)
    d(resourceId="com.google.android.apps.photos:id/cpe_save_button").click()
    time.sleep(5)
...
def test_buyRightnow():
    ...
    if d(resourceId="com.autel.explorer:id/tv_common_title").exists():
        ...
        d(resourceId="com.autel.explorer:id/tv_item_content", text=u"My Devices").click()
    d.implicitly_wait(4)
    d(resourceId="com.autel.explorer:id/stv_purchase").click()
    time.sleep(8)
    d.press('home')
    time.sleep(2)

    if d(text=u"Autel Explorer").exists():
        d(text=u"Autel Explorer").click()
    else:
        i = 0
        while i <= 5:
...
while True:
    ...
    # print('\n4-2.4 有网时点击头像从相册选择')    # 有程序崩贵的BUG 必现，待修复
